 const userBookingEmailTemplate = (user_info, artist_info, service_details, totalAmount, booking_date, booking_time) => {
    const subject = 'Your Booking Confirmation - Makeup Munch';

    // Generate a list of services and sub-services for the user
    ...
    <head>
        ...
        <title>Booking Confirmation - Makeup Munch</title>
    </head>
        ...
        <table width="100%" cellspacing="0" cellpadding="0" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 10px; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
            <tr>
                <td style="background-color: #FF1493; text-align: center; padding: 30px;">
                    <h1 style="color: #ffffff; font-size: 28px; margin: 0;">Booking Confirmation</h1>
                </td>
            </tr>
            <tr>
                <td style="padding: 30px;">
                    <p style="font-size: 16px; color: #333333; margin-bottom: 20px;">Hello, ${user_info.name}!</p>
                    <p style="font-size: 16px; color: #333333; margin-bottom: 20px;">Your booking has been confirmed with the following details:</p>
                    <p style="font-size: 16px; color: #333333; margin-bottom: 10px;">
                        <strong style="color: #FF1493;">Date:</strong> ${booking_date}<br>
                        <strong style="color: #FF1493;">Time:</strong> ${booking_time}<br>
                        <strong style="color: #FF1493;">Artist:</strong> ${artist_info.name}
                    </p>
                    ${servicesList}
            ...
            <tr>
                <td style="background-color: #FFB6C1; padding: 20px; text-align: center;">
                    <p style="color: #333333; font-size: 14px; margin: 0;">Thank you for booking with Makeup Munch! We look forward to serving you.</p>
                    <p style="color: #333333; font-size: 14px; margin: 0;">If you need to make any changes, please contact us as soon as possible.</p>
                </td>
            </tr>
            <tr>
 ...
 module.exports = userBookingEmailTemplate;
